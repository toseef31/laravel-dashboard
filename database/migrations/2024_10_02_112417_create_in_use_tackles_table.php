...
return new class extends Migration
{
    ...
    {
        Schema::create('in_use_tackles', function (Blueprint $table) {
            $table->id();
            $table->string('tackle_id')->unique();
            ...
            $table->text('transition_regulator')->nullable();
    ...
    {
        Schema::dropIfExists('in_use_tackles');
    }
};
